            ...
            <div class="preview col-md-5">
              <div class="preview-pic tab-content">
                <div class="tab-pane active" id="pic-1">
                  <img class="w-75" :src="product.major_image.conversions.md" />
                </div>
              </div>
              <!-- <div v-if="product" class="preview-thumbnail nav nav-tabs">
               <img :src="product.major_image.conversions.sm" alt="">
              </div>  -->
            </div>
